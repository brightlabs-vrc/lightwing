...
export function Environment(name: string): BaseURL {
    return `https://${name}-vgvds.encr.app`
}
...
/**
 * Client is an API client for the vgvds Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "vgvds-Generated-TS-Client (Encore/v1.57.9)";
        }
