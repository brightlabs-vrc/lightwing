...
export function Environment(name: string): BaseURL {
    return `https://${name}-pyfyg.encr.app`
}
...
/**
 * Client is an API client for the pyfyg Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "pyfyg-Generated-TS-Client (Encore/v1.57.11)";
        }
