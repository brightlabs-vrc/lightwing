// Code generated by the Encore v1.57.12 client generator. DO NOT EDIT.
...
export namespace eventmanager {
    ...
    export interface JoinRaceEventParams {
        authorization: string
    }
    ...
    export interface LeaveRaceEventParams {
        authorization: string
    }
    ...
    export interface SetSignupsLockedParams {
        authorization: string
        locked: boolean
    }
    ...
    deleted: boolean
         ...
         */
        public async joinEvent(id: string, params: JoinEventParams): Promise<EventDetail> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
         ...
         */
        public async joinRaceEvent(eventId: string, raceId: string, params: JoinRaceEventParams): Promise<RaceEventDetail> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/api/events/${encodeURIComponent(eventId)}/races/${encodeURIComponent(raceId)}/join`, undefined, {headers})
            return await resp.json() as RaceEventDetail
        }
         ...
         */
        public async leaveEvent(id: string, params: LeaveEventParams): Promise<EventDetail> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
         ...
         */
        public async leaveRaceEvent(eventId: string, raceId: string, params: LeaveRaceEventParams): Promise<RaceEventDetail> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/api/events/${encodeURIComponent(eventId)}/races/${encodeURIComponent(raceId)}/join`, undefined, {headers})
            return await resp.json() as RaceEventDetail
        }
    ...
    results: RaceResultView[]
         ...
         */
        public async setEventSignupsLocked(id: string, params: SetSignupsLockedParams): Promise<EventDetail> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PUT", `/api/events/${encodeURIComponent(id)}/signups-lock`, JSON.stringify(body), {headers})
            return await resp.json() as EventDetail
        }
