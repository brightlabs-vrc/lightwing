...
const MUTATING_ENDPOINTS: EndpointRule[] = [
  ...
  {
    file: "eventmanager/event-updates.ts",
  ...
  {
    file: "eventmanager/event-members.ts",
  ...
  {
    file: "eventmanager/event-schedules.ts",
  ...
  {
    file: "eventmanager/event-scoring.ts",
  ...
  {
    file: "eventmanager/results-bulk.ts",
